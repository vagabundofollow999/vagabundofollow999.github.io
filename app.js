...
// Ajuste responsivo según dispositivo
function adaptPlayerToDevice() {
    const video = document.getElementById("youtube-theme");
    ...
    } else if(width <= 1280){ // tablet/PC
        video.style.width = "100%";
        video.style.height = "100%";
        video.style.objectFit = "contain";
    } else { // Android TV / pantallas grandes
        video.style.width = "100%";
        video.style.height = "100%";
...
// Adaptar player si se cambia tamaño / orientación
window.addEventListener("resize", adaptPlayerToDevice);
